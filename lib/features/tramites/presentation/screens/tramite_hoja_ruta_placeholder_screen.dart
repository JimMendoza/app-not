...
class TramiteHojaRutaPlaceholderScreen extends ConsumerWidget {
  final int tramiteId;
  final String codigo;

  const TramiteHojaRutaPlaceholderScreen({
    super.key,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      'Tramite $codigo (ID: $tramiteId).\nEsta vista se completara en el siguiente bloque.',
                      textAlign: TextAlign.center,
                      style: GoogleFonts.montserrat(
                        fontSize: 14,
                    ...
                    FilledButton.icon(
                      onPressed: () => context.go('/tramites'),
                      style: FilledButton.styleFrom(
                        backgroundColor: const Color(0xFF99569E),
                      ),
                      icon: const Icon(Icons.arrow_back),
                      label: const Text('Volver a tramites'),
                    ),
                  ],
                ),
              ),
